...
action_11 (8) = happyShift action_8
...
action_17 (8) = happyShift action_8
action_17 (9) = happyShift action_9
...
happyReduction_7 (HappyTerminal (TokenNumber happy_var_1))
	 =  HappyAbsSyn4
		 (happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TokenNumber happy_dollar_dollar -> cont 5;
	TokenPlus -> cont 6;
	TokenMinus -> cont 7;
	TokenTimes -> cont 8;
	TokenDiv -> cont 9;
